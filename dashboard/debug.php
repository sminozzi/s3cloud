...
<big>
	...
	<br><br>
	<textarea style="height:100vh;width:100%" readonly="readonly" onclick="this.focus(); this.select()"><?php echo esc_attr(s3cloud_sysinfo_get()); ?></textarea>
	<?php
	function s3cloud_sysinfo_get()
	{
		global $wpdb;
		...
		$return .= 'OS Type & Version:        ' . s3cloud_OSName();
